...
const styles = StyleSheet.create({
  ...
  title:{fontFamily:FONTS.PROXIMA_NOVA,fontWeight:'bold',fontSize:18,textAlign:'center',marginTop:15},
  content:{fontFamily:FONTS.PROXIMA_NOVA,fontSize:14,textAlign:'center',lineHeight:22,margin:15},
});
